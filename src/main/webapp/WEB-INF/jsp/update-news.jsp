...
<!-- Bracket CSS -->
<link rel="stylesheet" href="../../static/css1/bracket.css">
</head>
...
<body>
	...
	<div class="br-sideleft overflow-y-auto">
		...
		<div class="br-sideleft-menu">
			...
			<!-- br-menu-link -->
			<ul class="br-menu-sub nav flex-column">
				<li class="nav-item"><a href="#" class="nav-link">Background</a></li>
				<li class="nav-item"><a href="#" class="nav-link">Border</a></li>
				<li class="nav-item"><a href="#" class="nav-link">Height</a></li>
				<li class="nav-item"><a href="#" class="nav-link">Margin</a></li>
				<li class="nav-item"><a href="#" class="nav-link">Padding</a></li>
				<li class="nav-item"><a href="#" class="nav-link">Position</a></li>
				<li class="nav-item"><a href="#"
					class="nav-link">Typography</a></li>
				<li class="nav-item"><a href="#" class="nav-link">Width</a></li>
			</ul>
			<!-- br-menu-link -->
			<!-- d-flex -->
		</div>
	...
	<div class="br-sideright">
		<ul class="nav nav-tabs sidebar-tabs" role="tablist">
			<li class="nav-item"><a class="nav-link active"
				data-toggle="tab" role="tab" href="#"><i
	...
	<div class="br-mainpanel">
		<div class="br-pageheader pd-y-15 pd-l-20">
			<nav class="breadcrumb pd-0 mg-0 tx-12">
				<a class="breadcrumb-item" href="index.jsp">ISSCE</a> <a
		...
		<div class="br-pagebody">
			<div class="br-section-wrapper">
				<!-- 				<form method="POST" action="form-validation.jsp save-news" data-parsley-validate> -->
	...
	<script src="../../static/js1/bracket.js"></script>
	<script>
		$(function() {
			'use strict';
